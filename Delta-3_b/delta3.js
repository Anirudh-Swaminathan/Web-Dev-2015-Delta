...
if(sessionStorage.getItem("top")!== null) document.getElementById("moveIt").style.top = parseInt(sessionStorage.getItem("top"))+"px";
else document.getElementById("moveIt").style.top = 0+"px";
if(sessionStorage.getItem("left")!==null) document.getElementById("moveIt").style.left = parseInt(sessionStorage.getItem("left"))+"px";
else document.getElementById("moveIt").style.left = 100+"px";
...
document.body.onkeydown = function(eve){
	...
	sessionStorage.setItem("top",moveIt.style.top);
	sessionStorage.setItem("left",moveIt.style.left);
